...
from rainbowarena.games.splendor_v2 import Player
from rainbowarena.games.splendor_v2 import Round
from rainbowarena.games.splendor_v2 import Judger
    ...
    def extract_action_state(self, action, player):
        ...
        if action < 5:
            ...
            for i in range(len(FETCH_DIFF_TOKENS[action - 5])):
                info_token[FETCH_DIFF_TOKENS[action - 5][i]] += 1
            info_card.extend([-1, -1])
