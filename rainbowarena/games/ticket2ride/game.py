...
from rainbowarena.games.ticket2ride import Player
from rainbowarena.games.ticket2ride import Round
from rainbowarena.games.ticket2ride import Judger
...
class Ticket2RideGame:
    ...
    def step(self, action, ui=False):
        ...
        self.history_action.append(
            (self.round.current_player, self.extract_action_state_baseline(action, player)))  # 存储历史动作信息
