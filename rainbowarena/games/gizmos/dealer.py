# from rlcard.games.splendor.utils import init_tokens, init_cards

# from utils import init_cards, init_tokens

from rainbowarena.games.gizmos.utils import init_cards, init_tokens
from rainbowarena.games.gizmos.card import GizmosCard
import numpy as np
...
class GizmosDealer:
    ...
    def __init__(self, np_random=np.random.RandomState(), num_players=2):
        ...
        self.tokens = init_tokens(num_players)  # 初始化宝石库，这里应该对应一个序列
        self.shuffle()  # 随机洗牌
