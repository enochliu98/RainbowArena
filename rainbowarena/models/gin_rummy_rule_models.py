...
if TYPE_CHECKING:
    from rainbowarena.core import Card
...
from rainbowarena.games.gin_rummy.utils.action_event import *

import rainbowarena.games.gin_rummy.utils.melding as melding
import rainbowarena.games.gin_rummy.utils.utils as utils
...
class GinRummyNoviceRuleModel(Model):
    ...
    def __init__(self):
        ...
        '''
        super().__init__()
        env = rainbowarena.make('gin-rummy')
