...
class DoudizhuEnv(Env):
    ...
    def __init__(self, config):
        from rainbowarena.games.doudizhu.utils import ACTION_2_ID, ID_2_ACTION
        from rainbowarena.games.doudizhu.utils import cards2str, cards2str_with_suit
        from rainbowarena.games.doudizhu import Game
