...
from rainbowarena.games.nolimitholdem import Game
from rainbowarena.games.nolimitholdem.round import Action
...
class NolimitholdemEnv(Env):
    ...
    def __init__(self, config):
        ...
        with open(os.path.join(rainbowarena.__path__[0], 'games/limitholdem/card2index.json'), 'r') as file:
